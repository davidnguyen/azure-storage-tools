...
{
    /// <summary>
    /// Represents common file MIME types
    /// </summary>
    public static class MimeTypes
    {
        ...
        /// <summary>
        /// Gets file MIME type from a file name based on file extension
        /// </summary>
        ...
        public static string FromFileName(string fileName)
        {
            ...
            {
                return MimeTypesDictionary[fileExtension];
            }
